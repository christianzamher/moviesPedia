...
//API call
  useEffect(() => {
    const VideoPoint = `https://api.themoviedb.org/3/movie/${movieID}/videos?api_key=08a8246a9e59f864e9c48e34d244f625&include_adult=false&include_video=false&language=en`;
    axios
      .get(VideoPoint)
      .then((response) => {
